...
- Model configuration includes exact profiles for Gemma `UD-Q4_K_XL`, `unsloth/Qwen3.8-27B-GGUF:UD-Q4_K_M`, and resource-gated `unsloth/Qwen3.8-Flash-Next-GGUF:UD-IQ3_XXS`.
