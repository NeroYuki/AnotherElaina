...
const server_address = process.env.BOT_ENV === 'lan' ? 'http://192.168.1.6:7051' : 'http://192.168.196.142:7051'
const mapset_verifier_address = 'http://192.168.1.6:7052'
...
module.exports = {
    ...
    async execute_inference(interaction, params, client, msgRef = null) {
        ...
        const is_using_gpu = ['http://192.168.1.6:7051', 'http://192.168.196.142:7051'].includes(request_server_address);
    ...
    async execute(interaction, client) {
        ...
        // Run MapsetVerifier — always runs on the Windows machine at 192.168.1.6
